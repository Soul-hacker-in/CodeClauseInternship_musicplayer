...
class Player(ttk.Frame):
    ...
    def __init__(self, master):
        ...
        self.play_list = Listbox(master, font="Sansarif 12 bold", bd=5,
                            bg="#081b29", width=37, height=19, selectbackground="#081b29")
        ...
        self.var = StringVar()
        self.var.set("..............................................................................")
        self.song_title = Label(master, font="Helvetica 12 bold", bg="#081b29",
                        fg="#081b29", width=55, textvariable=self.var)
    ...
    def help(self):
        ...
        user_manual = [
            ...
            "7. unmute symbol = 🔇",
            "8. stop button = ■ ",
            "\n\n| Made by Soul | Copyright @ 2023 |\n"
        ]
        for i in user_manual:
            manual = Label(top, text=i, width=50, height=3,
                        font="Helvetica, 11", bg="#081b29", fg="#081b29")
    ...
    def main_window(self):
        ...
        self.button_play = Button(self.master, text=self.PLAY, width=5, bd=5, bg="#081b29",
                            fg="#081b29", font="Helvetica, 15", command=self.play_thread)
        self.button_play.place(x=150, y=423)
        
        self.button_prev = Button(self.master, text=self.FWD, width=5, bd=5,
                            font="Helvetica, 15", bg="#081b29", fg="#081b29", command=self.next)
        self.button_prev.place(x=300, y=423)
        
        self.button_next = Button(self.master, text=self.RWD, width=5, bd=5, bg="#081b29",
                            fg="#081b29", font="Helvetica, 15", command=self.prev)
        self.button_next.place(x=10, y=423)
        
        self.button_stop = Button(self.master, text=self.STOP, width=5, bd=5,
                            font="Helvetica, 15", bg="#081b29", fg="#081b29", command=self.stop)
        self.button_stop.place(x=225, y=423)
        
        self.button_play_all = Button(
            self.master, text='\U0001F500' , 
            bg='#081b29', fg='#081b29', font='Helvetica, 15' , bd=5,
            width=3,
        ...
        self.button_pause = Button(self.master, text=self.PAUSE, width=4, bd=5,
                            font="Helvetica, 15", bg="#081b29", fg="#081b29", command=self.pause_unpause)
        self.button_pause.place(x=85, y=423)

        self.button_mute = Button(self.master, text=self.UN_MUTE, width=2, bd=5,
                            font="Helvetica, 15", bg="#081b29", fg="#081b29", command=self.muted)
        ...
        self.button_load_music = Button(self.master, text=f"{Emoji.get('open file folder')} ♫ open folder with your music ♫ ", 
                                        width=40, height=2,
                                bd=5, font="Helvetica, 11", fg="#081b29", command=self.add_songs_playlist)
        ...
        self.style.configure("greyish.Horizontal.TProgressbar", troughcolor ="#081b29")
        ...
        self.label_time = Label(self.master, text="00:00:00 / 00:00:00",
                            width=17, font="Helvetica, 10", bg="#081b29", fg="#081b29")
