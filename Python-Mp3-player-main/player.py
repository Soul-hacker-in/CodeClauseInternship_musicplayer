...
play_list = Listbox(root, font="Sansarif 12 bold", bd=5,
                    bg="white", width=37, height=19, selectbackground="#081b29")
...
var = StringVar()
var.set("..............................................................................")
song_title = Label(root, font="Helvetica 12 bold", bg="#081b29",
...
def help():
    ...
    for i in user_manual:
        manual = Label(top, text=i, width=50, height=3,
                       font="Helvetica, 11", bg="#081b29", fg="white")
...
button_play = Button(root, text=PLAY, width=5, bd=5, bg="#081b29",
...
button_load_music = Button(root, text="♫ Click Here To Load The Music ♫", width=43,
                           bd=5, font="Helvetica, 10", bg="#081b29", fg="white", command=add_songs_playlist)
...
label_time = Label(root, text="00:00:00 / 00:00:00",
                       width=17, font="Helvetica, 10", bg="#081b29", fg="white")
